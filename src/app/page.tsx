    ...
    <section className="bg-linear-to-b from-brand-panel/90 to-brand-panel2/70 border border-brand-stroke/35 shadow-[inset_0_0_0_1px_rgba(122, 63, 255,0.08),0_18px_60px_rgba(0,0,0,0.55)] rounded-[22px] overflow-hidden">
      <div className="flex flex-wrap items-center justify-between gap-2.5 px-4 py-3.5 border-b border-brand-stroke/25">
        <div className="flex flex-col gap-1">
          ...
          <b className="text-lg tracking-wide text-brand-text"> </b>
        </div>
      ...
      <div className="p-4 flex flex-col gap-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          ...
          >
            ...
            <b className="text-lg block mt-1.5">Inicio</b>
            <div className="text-brand-muted text-xs mt-2 leading-relaxed">
              Estadísticas, búsqueda rápida y últimos robots.
            </div>
          </Link>
          ...
          >
            ...
            <div className="text-brand-muted text-xs mt-2 leading-relaxed">
              Usa tu generador actual (offline o link) y guarda en la base de
              datos.
            </div>
          </Link>
          ...
          >
            ...
            <div className="text-brand-muted text-xs mt-2 leading-relaxed">
              Robots que tú registraste desde este navegador (sin login).
            </div>
          </Link>
          ...
          >
            ...
            <div className="text-brand-muted text-xs mt-2 leading-relaxed">
              Gestión de torneos: crear llaves, inscripción de robots y
              brackets.
            </div>
          </Link>
          ...
          >
            ...
            <div className="text-brand-muted text-xs mt-2 leading-relaxed">
              Ver torneos próximos y anteriores con conteo regresivo y detalles.
            </div>
            <div className="mt-3">
              <span className="border border-brand-neon/45 bg-linear-to-r from-brand-neon/28 to-brand-neon2/10 shadow-[inset_0_0_0_1px_rgba(122,63,255,0.12)] text-brand-text px-3 py-2.5 rounded-xl font-extrabold tracking-wide text-sm w-full block text-center">
                Abrir calendario
              </span>
            </div>
          </Link>
          ...
          >
            ...
            <div className="text-brand-muted text-xs mt-2 leading-relaxed">
              Explora equipos y sus robots registrados. (Escuela + nombre de
              equipo)
            </div>
            <div className="mt-3">
              <span className="border border-brand-neon2/25 bg-brand-panel2/55 text-brand-text px-3 py-2.5 rounded-xl font-extrabold tracking-wide text-sm w-full block text-center">
                Ver equipos
              </span>
            </div>
          </Link>
        ...
        <div className="text-brand-muted/80 text-xs tracking-wide uppercase mt-3 mb-1">
          Estadísticas
        </div>
        <DashboardStats />

        <div className="text-brand-muted/80 text-xs tracking-wide uppercase mt-3 mb-1">
          Buscar robot (por Robot ID)
        </div>
        <div className="flex gap-2.5 px-3 py-3 rounded-[18px] border border-brand-neon/20 bg-brand-bg/25 items-center">
          ...
          <button
            ...
            className="border border-brand-stroke/45 bg-linear-to-r from-brand-stroke/30 to-brand-neon/10 shadow-[inset_0_0_0_1px_rgba(122,63,255,0.12)] text-brand-text px-4 py-2.5 rounded-xl font-extrabold tracking-wide hover:brightness-110 cursor-pointer"
          >
            Abrir
          </button>
        </div>

        <div className="text-brand-muted/80 text-xs tracking-wide uppercase mt-5 mb-1">
          Últimos robots
        </div>
        <LatestRobots />
      </div>
